...
class DistributedDcrGraph(DcrGraph):
    ...
    @principals.setter
    def principals(self, value: Set[str]):
        self.__principals = value
    ...
    def role_assignments(self, value: dict):
        self.__roleAssignments = value

    @property
    def principals_assignments(self) -> dict:
        return self.__principalsAssignments

    @principals_assignments.setter
    def principals_assignments(self, value: dict):
        self.__principalsAssignments = value
